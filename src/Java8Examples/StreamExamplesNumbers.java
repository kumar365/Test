...
public class StreamExamplesNumbers {
	public static void main(String args[]) {
		...
		removeDuplicateElementsInList(list);
		duplicateElementsInList(list);
		findFirstElement(list);
		findTheTotalNumberOfElements(list);
		findMinElement(list);
		findMaxElement(list);

		sortValuesInList(list);
		sortDescending(list);
		cubeOnList();
	...
	public static void removeDuplicateElementsInList(List<Integer> list) {
...
//		System.out.println();
	...
	public static void duplicateElementsInList(List<Integer> list) {
	...
	public static void findTheTotalNumberOfElements(List<Integer> list) {
	...
	public static void findMaxElement(List<Integer> list) {
	...
	public static void sortValuesInList(List<Integer> list) {
	...
	public static void primeNumbersInList() {
		...
		List<Integer> primes = numbers.stream().filter(StreamExamplesNumbers::isPrime)
